#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/HarunKilic/ProxmoxVE/main/misc/build.func)
...
function update_script() {
    ...
    RELEASE=v$(curl -fsSL https://api.github.com/repos/zitadel/zitadel/releases/latest | grep "tag_name" | awk '{print substr($2, 3, length($2)-4) }')
